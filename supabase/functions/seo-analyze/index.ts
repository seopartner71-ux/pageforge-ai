...
Верни JSON:
{
  ...
  "implementationPlan": [
    {
      "priority": "P1|P2|P3",
      "title": "<Конкретное действие, например 'Исправить переспам слова цена'>",
      "where": "<Где именно на странице править, например 'Второй абзац раздела Услуги'>",
      "action": "<Что конкретно сделать: 'Удали 3 вхождения слова цена, замени на стоимость или прайс'>",
      "expectedResult": "<Ожидаемый результат: 'Снизит риск фильтра за спам, +10-15 пунктов SEO Score'>",
      "weight": <1-10>
    }
  ]
}
...
Верни JSON:
{
  ...
  "aiReport": {
    "summary": "<2-3 абзаца>",
    "strengths": ["..."], "weaknesses": ["..."], "recommendations": ["..."],
    "missingEntities": ["<10 LSI-сущностей, критичных для ниши, но отсутствующих>"],
    "geoScore": <0-100>,
