...
const TRANSAC = [
  "купить", "заказать", "доставка", "цена", "стоимость",
  "оплатить", "оформить", "лизинг", "кредит", "скидка",
  "недорого", "дешево", "под заказ", "интернет магазин", "интернет-магазин",
  "оптом", "прайс", "акция", "распродажа",
];
const COMMERCIAL = [
  "лучший", "лучшие", "рейтинг", "сравнить", "сравнение",
  "отзывы", "топ", "выбрать", "какой", "какие",
];
