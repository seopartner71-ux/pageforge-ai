...
interface Props { rows: CompetitorRow[]; initialMarkdown?: string | null; onMarkdown?: (md: string | null) => void }

export function AiInsights({ rows, initialMarkdown, onMarkdown }: Props) {
