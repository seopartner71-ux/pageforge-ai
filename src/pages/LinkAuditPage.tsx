    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-6 space-y-6">
        ...
        <PageDescription
          ...
          help={{
            content: [
              'Ссылки остаются одним из подтверждённых сигналов ранжирования Google (Andrey Lipattsev, Google Q&A, 2016). Google использует PageRank и его модификации для оценки авторитетности страниц, однако приоритет отдаётся качеству и тематической релевантности доноров, а не количеству.',
              'Признаки токсичных ссылок согласно политике Google против ссылочного спама: покупные ссылки с передачей PageRank, массовые обмены, ссылки со взломанных сайтов, ссылки с PBN, скрытые ссылки, нерелевантные комментарии-спам, ссылки из футеров шаблонов. Такие ссылки следует отклонять через Disavow Tool.',
