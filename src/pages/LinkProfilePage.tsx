  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-6 space-y-5">
        ...
        <PageDescription
          items={[
            { label: 'Что отслеживается', value: 'Каждая размещённая ссылка: донор, анкор, акцептор, цена и дата размещения' },
            { label: 'Как работает проверка', value: 'Загружаем HTML страницы-донора и ищем ваш URL в коде. Найдено — Активна, нет — Потеряна' },
            { label: 'Метрики', value: 'Сводка по бюджету, активным, потерянным и ожидающим проверки ссылкам' },
            { label: 'Импорт', value: 'Массовая загрузка из CSV: donor_url, anchor, acceptor_url, type, cost' },
          ]}
          help={{
